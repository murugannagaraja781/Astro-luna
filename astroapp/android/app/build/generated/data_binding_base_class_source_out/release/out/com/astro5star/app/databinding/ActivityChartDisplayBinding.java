...
public final class ActivityChartDisplayBinding implements ViewBinding {
  ...
  private ActivityChartDisplayBinding(@NonNull LinearLayout rootView,
      @NonNull WebView webViewChart) {
    this.rootView = rootView;
    this.webViewChart = webViewChart;
  }
  ...
  public static ActivityChartDisplayBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.webViewChart;
      WebView webViewChart = ViewBindings.findChildViewById(rootView, id);
      if (webViewChart == null) {
        break missingId;
      }

      return new ActivityChartDisplayBinding((LinearLayout) rootView, webViewChart);
    }
