...
class HomeActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        // private const val SERVER_URL = "https://astroluna.com" // Removed wrong URL
    }
        ...
        com.google.firebase.messaging.FirebaseMessaging.getInstance().token.addOnCompleteListener { task ->
            if (task.isSuccessful) {
                ...
                if (token != null && userId != null) {
                    Log.d(TAG, "FCM Token found: $token")
    ...
    private suspend fun fetchHoroscope(): String = withContext(Dispatchers.IO) {
        val request = Request.Builder()
                .url("${com.astroluna.app.utils.Constants.SERVER_URL}/api/daily-horoscope")
            .get()
            .build()
    ...
    private suspend fun fetchAstrologers(): List<Astrologer> = withContext(Dispatchers.IO) {
        ...
        try {
            val request = Request.Builder()
                .url("${com.astroluna.app.utils.Constants.SERVER_URL}/api/astrology/astrologers")
                .get()
                .build()
