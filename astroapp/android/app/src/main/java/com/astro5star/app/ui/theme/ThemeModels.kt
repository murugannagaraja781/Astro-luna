...
object ThemePalette {
    ...
    private val PremiumTemplate = ThemeColors(
        bgStart = Color(0xFFFFFFFF), // Pure White
        bgCenter = Color(0xFFFFFFFF), // Pure White
        bgEnd = Color(0xFFF5F6FA), // Light Grey
        headerStart = Color(0xFF6C3BFF), // Primary Purple
        headerEnd = Color(0xFF6C3BFF), // Primary Purple (Solid for now)
        cardBg = Color(0xFFFFFFFF), // Pure White
        cardStroke = Color(0xFFE5E7EB), // Light Border
        textPrimary = Color(0xFF111827), // Near Black
        textSecondary = Color(0xFF6B7280), // Grey Text
        accent = Color(0xFF14B8A6) // Accent Teal
    )
